...
def test_template_in_request_folder_is_found(tmp_path: Path):
    repo_root = tmp_path
    ...
    request_yaml = """request_id: RITM999004
platform: databricks
request_type: object_access
...
template_file: ObjectAccessTemplate.csv
justification: Local template validation
"""
    request_path = repo_root / "requests" / "object-access" / "dev" / "RITM999004.yaml"
    request_path.write_text(request_yaml, encoding="utf-8")

    template_csv = """Object Type,Activity,Catalog Name,Schema Name,Object Name,Folder Path,Privileges
catalog,ADD,finance_catalog,,,,USE_CATALOG
"""
    (request_path.parent / "ObjectAccessTemplate.csv").write_text(template_csv, encoding="utf-8")
